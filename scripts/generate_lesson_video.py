...
def build_scene_video(slide_png, audio_path, srt_path, output_path, workdir):
    ...
    subprocess.run([
        ...
        "-loop", "1", "-i", slide_png,
        "-i", audio_path,
        "-vf", f"{zoom_expr},subtitles={srt_path}:force_style='Fontsize=22,Alignment=2,MarginV=40,PrimaryColour=&H00FFFFFF,OutlineColour=&H00000000,BorderStyle=3,Outline=2,Shadow=1'",
