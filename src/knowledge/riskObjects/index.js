...
const RISK_META = {
  ...
  SCH: [
    ...
    { riskId: 'RISK-SC-007', riskCode: 'SC-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Business', category: 'Financial', subcategory: 'Business Continuity', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'School cannot sustain staff salaries and expenses during a one-month unexpected closure.', customer: 'A one-month closure would financially cripple your school.', technical: 'Educational institution lacks financial reserves to cover operating expenses during a one-month closure.' }, businessContext: ['School'], question: 'SCH_022', triggerAnswers: ['No', 'Not sure'], penaltyScore: 20, impacts: ['Financial', 'Operational'], detectability: 'High', preventability: 'High', recoverability: 'Low' },
  ...
  MFG: [
    ...
    { riskId: 'RISK-MF-008', riskCode: 'MF-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Business', category: 'Business Continuity', subcategory: 'Financial Resilience', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'No Financial Resilience to Closure identified in manufacturing operations.', customer: 'Your operation could not sustain expenses during a one-month unexpected closure.', technical: 'Customer reports insufficient financial reserves to cover operating expenses during a one-month closure.' }, businessContext: ["Manufacturing"], question: 'MFG_022', triggerAnswers: ["No","Not sure"], penaltyScore: 25, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
  ...
  HOS: [
    ...
    { riskId: 'RISK-HO-008', riskCode: 'HO-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Business', category: 'Operations', subcategory: 'Financial Resilience', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'No Financial Resilience to Closure identified in healthcare operations.', customer: 'Your operation could not sustain expenses during a one-month unexpected closure.', technical: 'Customer reports insufficient financial reserves to cover operating expenses during a one-month closure.' }, businessContext: ["Healthcare"], question: 'HOS_022', triggerAnswers: ["No","Not sure"], penaltyScore: 25, impacts: ["Operational","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
  ...
  CHR: [
    ...
    { riskId: 'RISK-CH-008', riskCode: 'CH-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Business', category: 'Operations', subcategory: 'Financial Resilience', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'No Financial Resilience to Closure identified in church operations.', customer: 'Your operation could not sustain expenses during a one-month unexpected closure.', technical: 'Customer reports insufficient financial reserves to cover operating expenses during a one-month closure.' }, businessContext: ["Church"], question: 'CHR_022', triggerAnswers: ["No","Not sure"], penaltyScore: 25, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
