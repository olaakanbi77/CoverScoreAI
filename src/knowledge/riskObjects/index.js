...
const RISK_META = {
  ...
  SCH: [
    ...
    { riskId: 'RISK-SC-004', riskCode: 'SC-STUDENT-ACCIDENTS', name: 'Student Accident History', domain: 'Business', category: 'Operations', subcategory: 'Student Safety', family: 'Operational Risk', severity: 'Moderate', definition: { official: 'Student accidents have occurred on school premises in the past 3 years, indicating safety gaps.', customer: 'Student accidents on your premises indicate safety gaps.', technical: 'Educational institution reports student accidents on premises in the past 3 years.' }, businessContext: ['School'], question: 'SCH_012', triggerAnswers: ['Yes'], penaltyScore: 15, impacts: ['Legal', 'Operational'], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-SC-005', riskCode: 'SC-NO-EMERGENCY-PROCEDURES', name: 'No Written Emergency Procedures', domain: 'Business', category: 'Operations', subcategory: 'Emergency Preparedness', family: 'Operational Risk', severity: 'High', definition: { official: 'No written emergency procedures for student accidents or fire leaves the school unprepared.', customer: 'Your school has no documented emergency procedures.', technical: 'Educational institution lacks written emergency procedures for student accidents or fire.' }, businessContext: ['School'], question: 'SCH_020', triggerAnswers: ['No'], penaltyScore: 18, impacts: ['Operational', 'Legal'], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-SC-006', riskCode: 'SC-NO-FIRE-EXTINGUISHERS', name: 'No Fire Extinguisher Coverage', domain: 'Property', category: 'Asset Protection', subcategory: 'Fire Safety', family: 'Property Risk', severity: 'High', definition: { official: 'Fire extinguishers are not regularly inspected or available across the school.', customer: 'Your school lacks proper fire extinguisher coverage.', technical: 'Educational institution lacks regularly inspected fire extinguishers across all buildings.' }, businessContext: ['School'], question: 'SCH_021', triggerAnswers: ['No'], penaltyScore: 15, impacts: ['Property', 'Operational'], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-SC-007', riskCode: 'SC-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Business', category: 'Financial', subcategory: 'Business Continuity', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'School cannot sustain staff salaries and expenses during a three-month unexpected closure.', customer: 'A three-month closure would financially cripple your school.', technical: 'Educational institution lacks financial reserves to cover operating expenses during a three-month closure.' }, businessContext: ['School'], question: 'SCH_022', triggerAnswers: ['No', 'Not sure'], penaltyScore: 20, impacts: ['Financial', 'Operational'], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-SC-008', riskCode: 'SC-NO-SAFETY-OWNER', name: 'No Designated Health and Safety Responsibility', domain: 'Legal', category: 'Regulatory Compliance', subcategory: 'Safety Governance', family: 'Compliance Risk', severity: 'Moderate', definition: { official: 'No one is specifically assigned responsibility for health and safety within the school.', customer: 'No one is responsible for health and safety at your school.', technical: 'Educational institution has no designated health and safety officer or assigned responsibility.' }, businessContext: ['School'], question: 'SCH_023', triggerAnswers: ['No one specifically assigned'], penaltyScore: 15, impacts: ['Legal', 'Operational'], detectability: 'High', preventability: 'High', recoverability: 'High' },
    { riskId: 'RISK-SC-009', riskCode: 'SC-NO-DRIVER-TRAINING', name: 'Untrained School Bus Drivers', domain: 'Business', category: 'Operations', subcategory: 'Transport Safety', family: 'Operational Risk', severity: 'High', definition: { official: 'School bus drivers lack first aid and defensive driving training.', customer: 'Your school bus drivers lack first aid and defensive driving training.', technical: 'School transport drivers have not been trained in first aid or defensive driving.' }, businessContext: ['School'], question: 'SCH_024', triggerAnswers: ['No'], penaltyScore: 15, impacts: ['Operational', 'Legal'], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-SC-010', riskCode: 'SC-NO-VEHICLE-INSPECTIONS', name: 'No Vehicle Safety Inspections', domain: 'Business', category: 'Operations', subcategory: 'Transport Safety', family: 'Operational Risk', severity: 'High', definition: { official: 'School transport vehicles lack regular safety inspections.', customer: 'Your school transport vehicles lack regular safety inspections.', technical: 'School does not conduct regular safety inspections on transport vehicles.' }, businessContext: ['School'], question: 'SCH_025', triggerAnswers: ['No'], penaltyScore: 15, impacts: ['Operational', 'Legal', 'Financial'], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-SC-011', riskCode: 'SC-NO-FIRE-ALARM', name: 'No Fire Alarm System', domain: 'Property', category: 'Asset Protection', subcategory: 'Fire Safety', family: 'Property Risk', severity: 'Critical', definition: { official: 'School does not have a working fire alarm system that is regularly tested.', customer: 'Your school lacks a working fire alarm system.', technical: 'Educational institution lacks a working, regularly tested fire alarm system.' }, businessContext: ['School'], question: 'SCH_026', triggerAnswers: ['No'], penaltyScore: 20, impacts: ['Property', 'Operational', 'Legal'], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-SC-012', riskCode: 'SC-POOR-BUILDING-MAINTENANCE', name: 'Infrequent Building Maintenance', domain: 'Property', category: 'Asset Protection', subcategory: 'Building Maintenance', family: 'Property Risk', severity: 'Moderate', definition: { official: 'Building maintenance inspections are not conducted on a regular schedule, leading to undetected facility issues.', customer: 'Building maintenance inspections at your school are infrequent or non-existent.', technical: 'Educational institution conducts building maintenance inspections rarely or never.' }, businessContext: ['School'], question: 'SCH_027', triggerAnswers: ['Rarely', 'Never'], penaltyScore: 12, impacts: ['Property', 'Operational'], detectability: 'High', preventability: 'High', recoverability: 'Medium' }
  ],
  MFG: [
    ...
    { riskId: 'RISK-MF-005', riskCode: 'MF-WORKPLACE-ACCIDENTS', name: 'Workplace Accident History', domain: 'Business', category: 'Workforce', subcategory: 'Workplace Safety', family: 'Operational Risk', severity: 'Critical', definition: { official: 'Workplace Accident History identified in manufacturing operations.', customer: 'Workplace accidents have occurred at your facility in the past 3 years.', technical: 'Customer reports workplace accidents on site in the past 3 years.' }, businessContext: ["Manufacturing"], question: 'MFG_012', triggerAnswers: ["Yes"], penaltyScore: 20, impacts: ["Legal","Operational"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-MF-006', riskCode: 'MF-NO-EMERGENCY-PROCEDURES', name: 'No Emergency Procedures', domain: 'Business', category: 'Operations', subcategory: 'Emergency Preparedness', family: 'Operational Risk', severity: 'Critical', definition: { official: 'No Emergency Procedures identified in manufacturing operations.', customer: 'You have no written emergency procedures for accidents or incidents.', technical: 'Customer reports no written emergency procedures for accidents or incidents.' }, businessContext: ["Manufacturing"], question: 'MFG_020', triggerAnswers: ["No"], penaltyScore: 20, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-MF-007', riskCode: 'MF-NO-FIRE-EXTINGUISHERS', name: 'No Fire Extinguisher Coverage', domain: 'Property', category: 'Asset Protection', subcategory: 'Fire Safety', family: 'Property Risk', severity: 'High', definition: { official: 'No Fire Extinguisher Coverage identified in manufacturing operations.', customer: 'Fire extinguishers are not regularly inspected or available across your facility.', technical: 'Customer reports fire extinguishers not regularly inspected or available across the facility.' }, businessContext: ["Manufacturing"], question: 'MFG_021', triggerAnswers: ["No"], penaltyScore: 15, impacts: ["Financial","Property"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-MF-008', riskCode: 'MF-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Business', category: 'Business Continuity', subcategory: 'Financial Resilience', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'No Financial Resilience to Closure identified in manufacturing operations.', customer: 'Your operation could not sustain expenses during a three-month unexpected closure.', technical: 'Customer reports insufficient financial reserves to cover operating expenses during a three-month closure.' }, businessContext: ["Manufacturing"], question: 'MFG_022', triggerAnswers: ["No","Not sure"], penaltyScore: 25, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-MF-009', riskCode: 'MF-NO-SAFETY-OWNER', name: 'No Designated Safety Responsibility', domain: 'Business', category: 'Operations', subcategory: 'Safety Governance', family: 'Compliance Risk', severity: 'Critical', definition: { official: 'No Designated Safety Responsibility identified in manufacturing operations.', customer: 'No one is specifically responsible for safety and compliance.', technical: 'Customer reports no designated person responsible for safety and compliance.' }, businessContext: ["Manufacturing"], question: 'MFG_023', triggerAnswers: ["No one specifically assigned"], penaltyScore: 20, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-MF-010', riskCode: 'MF-UNTRAINED-OPERATORS', name: 'Untrained Vehicle Operators', domain: 'Business', category: 'Operations', subcategory: 'Driver Training', family: 'Operational Risk', severity: 'Moderate', definition: { official: 'Untrained Vehicle Operators identified in manufacturing operations.', customer: 'Your vehicle and equipment operators lack safe operating procedure training.', technical: 'Customer reports vehicle and equipment operators not trained in safe operating procedures.' }, businessContext: ["Manufacturing"], question: 'MFG_025', triggerAnswers: ["No","Not sure"], penaltyScore: 12, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'High' },
    { riskId: 'RISK-MF-011', riskCode: 'MF-NO-VEHICLE-INSPECTIONS', name: 'No Vehicle Safety Inspections', domain: 'Business', category: 'Operations', subcategory: 'Vehicle Inspections', family: 'Operational Risk', severity: 'Moderate', definition: { official: 'No Vehicle Safety Inspections identified in manufacturing operations.', customer: 'Regular vehicle safety inspections are not conducted.', technical: 'Customer reports no regular vehicle safety inspections conducted.' }, businessContext: ["Manufacturing"], question: 'MFG_026', triggerAnswers: ["No","Not sure"], penaltyScore: 12, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'High' },
    { riskId: 'RISK-MF-012', riskCode: 'MF-POOR-BUILDING-MAINTENANCE', name: 'Infrequent Building Maintenance', domain: 'Property', category: 'Asset Protection', subcategory: 'Building Maintenance', family: 'Property Risk', severity: 'Critical', definition: { official: 'Infrequent Building Maintenance identified in manufacturing operations.', customer: 'Building or facility maintenance inspections are infrequent or non-existent.', technical: 'Customer reports building maintenance inspections conducted rarely or never.' }, businessContext: ["Manufacturing"], question: 'MFG_027', triggerAnswers: ["Rarely","Never"], penaltyScore: 20, impacts: ["Financial","Property"], detectability: 'High', preventability: 'High', recoverability: 'Low' }
  ],
  HOS: [
    ...
    { riskId: 'RISK-HO-005', riskCode: 'HO-PATIENT-INCIDENTS', name: 'Patient Safety Incident History', domain: 'Business', category: 'Operations', subcategory: 'Patient Safety', family: 'Operational Risk', severity: 'Critical', definition: { official: 'Patient Safety Incident History identified in healthcare operations.', customer: 'Patient safety incidents have occurred at your facility in the past 3 years.', technical: 'Customer reports patient safety incidents in the past 3 years.' }, businessContext: ["Healthcare"], question: 'HOS_012', triggerAnswers: ["Yes"], penaltyScore: 25, impacts: ["Operational","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-HO-006', riskCode: 'HO-NO-EMERGENCY-PROCEDURES', name: 'No Emergency Procedures', domain: 'Business', category: 'Operations', subcategory: 'Emergency Preparedness', family: 'Operational Risk', severity: 'Critical', definition: { official: 'No Emergency Procedures identified in healthcare operations.', customer: 'You have no written emergency procedures for accidents or incidents.', technical: 'Customer reports no written emergency procedures for accidents or incidents.' }, businessContext: ["Healthcare"], question: 'HOS_020', triggerAnswers: ["No"], penaltyScore: 20, impacts: ["Operational","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-HO-007', riskCode: 'HO-NO-FIRE-EXTINGUISHERS', name: 'No Fire Extinguisher Coverage', domain: 'Property', category: 'Asset Protection', subcategory: 'Fire Safety', family: 'Property Risk', severity: 'High', definition: { official: 'No Fire Extinguisher Coverage identified in healthcare operations.', customer: 'Fire extinguishers are not regularly inspected or available across your facility.', technical: 'Customer reports fire extinguishers not regularly inspected or available across the facility.' }, businessContext: ["Healthcare"], question: 'HOS_021', triggerAnswers: ["No"], penaltyScore: 15, impacts: ["Financial","Operational"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-HO-008', riskCode: 'HO-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Business', category: 'Operations', subcategory: 'Financial Resilience', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'No Financial Resilience to Closure identified in healthcare operations.', customer: 'Your operation could not sustain expenses during a three-month unexpected closure.', technical: 'Customer reports insufficient financial reserves to cover operating expenses during a three-month closure.' }, businessContext: ["Healthcare"], question: 'HOS_022', triggerAnswers: ["No","Not sure"], penaltyScore: 25, impacts: ["Operational","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-HO-009', riskCode: 'HO-NO-COMPLIANCE-OWNER', name: 'No Designated Compliance Responsibility', domain: 'Legal', category: 'Legal & Liability', subcategory: 'Compliance', family: 'Compliance Risk', severity: 'Critical', definition: { official: 'No Designated Compliance Responsibility identified in healthcare operations.', customer: 'No one is specifically responsible for safety and compliance.', technical: 'Customer reports no designated person responsible for safety and compliance.' }, businessContext: ["Healthcare"], question: 'HOS_023', triggerAnswers: ["No one specifically assigned"], penaltyScore: 20, impacts: ["Legal","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-HO-010', riskCode: 'HO-UNTRAINED-DRIVERS', name: 'Untrained Ambulance Drivers', domain: 'Business', category: 'Operations', subcategory: 'Driver Training', family: 'Operational Risk', severity: 'High', definition: { official: 'Untrained Ambulance Drivers identified in healthcare operations.', customer: 'Your vehicle and equipment operators lack safe operating procedure training.', technical: 'Customer reports vehicle and equipment operators not trained in safe operating procedures.' }, businessContext: ["Healthcare"], question: 'HOS_025', triggerAnswers: ["No","Not sure"], penaltyScore: 15, impacts: ["Operational","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-HO-011', riskCode: 'HO-NO-VEHICLE-INSPECTIONS', name: 'No Vehicle Safety Inspections', domain: 'Business', category: 'Operations', subcategory: 'Vehicle Inspections', family: 'Operational Risk', severity: 'Moderate', definition: { official: 'No Vehicle Safety Inspections identified in healthcare operations.', customer: 'Regular vehicle safety inspections are not conducted.', technical: 'Customer reports no regular vehicle safety inspections conducted.' }, businessContext: ["Healthcare"], question: 'HOS_026', triggerAnswers: ["No","Not sure"], penaltyScore: 12, impacts: ["Operational","Legal"], detectability: 'High', preventability: 'High', recoverability: 'High' },
    { riskId: 'RISK-HO-012', riskCode: 'HO-POOR-BUILDING-MAINTENANCE', name: 'Infrequent Building Maintenance', domain: 'Property', category: 'Asset Protection', subcategory: 'Building Maintenance', family: 'Property Risk', severity: 'Critical', definition: { official: 'Infrequent Building Maintenance identified in healthcare operations.', customer: 'Building or facility maintenance inspections are infrequent or non-existent.', technical: 'Customer reports building maintenance inspections conducted rarely or never.' }, businessContext: ["Healthcare"], question: 'HOS_027', triggerAnswers: ["Rarely","Never"], penaltyScore: 20, impacts: ["Financial","Operational"], detectability: 'High', preventability: 'High', recoverability: 'Low' }
  ],
  CHR: [
    ...
    { riskId: 'RISK-CH-005', riskCode: 'CH-PREMISES-INCIDENTS', name: 'Premises Incident History', domain: 'Legal', category: 'Legal & Liability', subcategory: 'Premises Safety', family: 'Operational Risk', severity: 'Critical', definition: { official: 'Premises Incident History identified in church operations.', customer: 'Incidents have occurred on your premises in the past 3 years.', technical: 'Customer reports premises incidents in the past 3 years.' }, businessContext: ["Church"], question: 'CHR_012', triggerAnswers: ["Yes"], penaltyScore: 20, impacts: ["Legal","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-CH-006', riskCode: 'CH-NO-EMERGENCY-PROCEDURES', name: 'No Emergency Procedures', domain: 'Business', category: 'Operations', subcategory: 'Emergency Preparedness', family: 'Operational Risk', severity: 'Critical', definition: { official: 'No Emergency Procedures identified in church operations.', customer: 'You have no written emergency procedures for accidents or incidents.', technical: 'Customer reports no written emergency procedures for accidents or incidents.' }, businessContext: ["Church"], question: 'CHR_020', triggerAnswers: ["No"], penaltyScore: 20, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-CH-007', riskCode: 'CH-NO-FIRE-EXTINGUISHERS', name: 'No Fire Extinguisher Coverage', domain: 'Property', category: 'Property Protection', subcategory: 'Fire Safety', family: 'Property Risk', severity: 'High', definition: { official: 'No Fire Extinguisher Coverage identified in church operations.', customer: 'Fire extinguishers are not regularly inspected or available across your facility.', technical: 'Customer reports fire extinguishers not regularly inspected or available across the facility.' }, businessContext: ["Church"], question: 'CHR_021', triggerAnswers: ["No"], penaltyScore: 15, impacts: ["Financial","Property"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-CH-008', riskCode: 'CH-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Business', category: 'Operations', subcategory: 'Financial Resilience', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'No Financial Resilience to Closure identified in church operations.', customer: 'Your operation could not sustain expenses during a three-month unexpected closure.', technical: 'Customer reports insufficient financial reserves to cover operating expenses during a three-month closure.' }, businessContext: ["Church"], question: 'CHR_022', triggerAnswers: ["No","Not sure"], penaltyScore: 25, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-CH-009', riskCode: 'CH-NO-SAFETY-OWNER', name: 'No Designated Safety Responsibility', domain: 'Legal', category: 'Legal & Liability', subcategory: 'Safety Governance', family: 'Compliance Risk', severity: 'Critical', definition: { official: 'No Designated Safety Responsibility identified in church operations.', customer: 'No one is specifically responsible for safety and compliance.', technical: 'Customer reports no designated person responsible for safety and compliance.' }, businessContext: ["Church"], question: 'CHR_023', triggerAnswers: ["No one specifically assigned"], penaltyScore: 20, impacts: ["Legal","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-CH-010', riskCode: 'CH-UNTRAINED-DRIVERS', name: 'Untrained Church Drivers', domain: 'Business', category: 'Operations', subcategory: 'Driver Training', family: 'Operational Risk', severity: 'High', definition: { official: 'Untrained Church Drivers identified in church operations.', customer: 'Your vehicle and equipment operators lack safe operating procedure training.', technical: 'Customer reports vehicle and equipment operators not trained in safe operating procedures.' }, businessContext: ["Church"], question: 'CHR_025', triggerAnswers: ["No","Not sure"], penaltyScore: 15, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-CH-011', riskCode: 'CH-NO-VEHICLE-INSPECTIONS', name: 'No Vehicle Safety Inspections', domain: 'Business', category: 'Operations', subcategory: 'Vehicle Inspections', family: 'Operational Risk', severity: 'Moderate', definition: { official: 'No Vehicle Safety Inspections identified in church operations.', customer: 'Regular vehicle safety inspections are not conducted.', technical: 'Customer reports no regular vehicle safety inspections conducted.' }, businessContext: ["Church"], question: 'CHR_026', triggerAnswers: ["No","Not sure"], penaltyScore: 12, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'High' },
    { riskId: 'RISK-CH-012', riskCode: 'CH-POOR-BUILDING-MAINTENANCE', name: 'Infrequent Building Maintenance', domain: 'Property', category: 'Property Protection', subcategory: 'Building Maintenance', family: 'Property Risk', severity: 'Critical', definition: { official: 'Infrequent Building Maintenance identified in church operations.', customer: 'Building or facility maintenance inspections are infrequent or non-existent.', technical: 'Customer reports building maintenance inspections conducted rarely or never.' }, businessContext: ["Church"], question: 'CHR_027', triggerAnswers: ["Rarely","Never"], penaltyScore: 20, impacts: ["Financial","Property"], detectability: 'High', preventability: 'High', recoverability: 'Low' }
  ],
  CON: [
    ...
    { riskId: 'RISK-CN-006', riskCode: 'CN-SITE-ACCIDENTS', name: 'On-Site Accident History', domain: 'Legal', category: 'Worker Protection', subcategory: 'Site Safety', family: 'Operational Risk', severity: 'Critical', definition: { official: 'On-Site Accident History identified in construction operations.', customer: 'On-site accidents have occurred at your construction sites in the past 3 years.', technical: 'Customer reports on-site accidents in the past 3 years.' }, businessContext: ["Construction"], question: 'CON_012', triggerAnswers: ["Yes"], penaltyScore: 20, impacts: ["Legal","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-CN-007', riskCode: 'CN-NO-EMERGENCY-PROCEDURES', name: 'No Emergency Procedures', domain: 'Business', category: 'Operations', subcategory: 'Emergency Preparedness', family: 'Operational Risk', severity: 'Critical', definition: { official: 'No Emergency Procedures identified in construction operations.', customer: 'You have no written emergency procedures for accidents or incidents.', technical: 'Customer reports no written emergency procedures for accidents or incidents.' }, businessContext: ["Construction"], question: 'CON_020', triggerAnswers: ["No"], penaltyScore: 20, impacts: ["Operational","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-CN-008', riskCode: 'CN-NO-FIRE-EXTINGUISHERS', name: 'No Fire Extinguisher Coverage', domain: 'Property', category: 'Insurance', subcategory: 'Fire Safety', family: 'Property Risk', severity: 'High', definition: { official: 'No Fire Extinguisher Coverage identified in construction operations.', customer: 'Fire extinguishers are not regularly inspected or available across your facility.', technical: 'Customer reports fire extinguishers not regularly inspected or available across the facility.' }, businessContext: ["Construction"], question: 'CON_021', triggerAnswers: ["No"], penaltyScore: 15, impacts: ["Financial","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-CN-009', riskCode: 'CN-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Legal', category: 'Contractual Risk', subcategory: 'Financial Resilience', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'No Financial Resilience to Closure identified in construction operations.', customer: 'Your operation could not sustain expenses during a one-month unexpected closure.', technical: 'Customer reports insufficient financial reserves to cover operating expenses during a one-month closure.' }, businessContext: ["Construction"], question: 'CON_022', triggerAnswers: ["No","Not sure"], penaltyScore: 25, impacts: ["Financial","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-CN-010', riskCode: 'CN-NO-SAFETY-OWNER', name: 'No Designated Safety Responsibility', domain: 'Legal', category: 'Worker Protection', subcategory: 'Safety Governance', family: 'Compliance Risk', severity: 'Critical', definition: { official: 'No Designated Safety Responsibility identified in construction operations.', customer: 'No one is specifically responsible for safety and compliance.', technical: 'Customer reports no designated person responsible for safety and compliance.' }, businessContext: ["Construction"], question: 'CON_023', triggerAnswers: ["No one specifically assigned"], penaltyScore: 20, impacts: ["Legal","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-CN-011', riskCode: 'CN-UNTRAINED-OPERATORS', name: 'Untrained Equipment Operators', domain: 'Business', category: 'Operations', subcategory: 'Operator Training', family: 'Operational Risk', severity: 'High', definition: { official: 'Untrained Equipment Operators identified in construction operations.', customer: 'Your vehicle and equipment operators lack safe operating procedure training.', technical: 'Customer reports vehicle and equipment operators not trained in safe operating procedures.' }, businessContext: ["Construction"], question: 'CON_025', triggerAnswers: ["No","Not sure"], penaltyScore: 15, impacts: ["Operational","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-CN-012', riskCode: 'CN-NO-VEHICLE-INSPECTIONS', name: 'No Vehicle Safety Inspections', domain: 'Business', category: 'Operations', subcategory: 'Vehicle Inspections', family: 'Operational Risk', severity: 'Moderate', definition: { official: 'No Vehicle Safety Inspections identified in construction operations.', customer: 'Regular vehicle safety inspections are not conducted.', technical: 'Customer reports no regular vehicle safety inspections conducted.' }, businessContext: ["Construction"], question: 'CON_026', triggerAnswers: ["No","Not sure"], penaltyScore: 12, impacts: ["Operational","Legal"], detectability: 'High', preventability: 'High', recoverability: 'High' },
    { riskId: 'RISK-CN-013', riskCode: 'CN-POOR-EQUIPMENT-MAINTENANCE', name: 'Infrequent Equipment Maintenance', domain: 'Property', category: 'Equipment', subcategory: 'Equipment Maintenance', family: 'Property Risk', severity: 'Critical', definition: { official: 'Infrequent Equipment Maintenance identified in construction operations.', customer: 'Building or facility maintenance inspections are infrequent or non-existent.', technical: 'Customer reports building maintenance inspections conducted rarely or never.' }, businessContext: ["Construction"], question: 'CON_027', triggerAnswers: ["Rarely","Never"], penaltyScore: 20, impacts: ["Operational","Property"], detectability: 'High', preventability: 'High', recoverability: 'Low' }
  ],
  TRN: [
    ...
    { riskId: 'RISK-TR-005', riskCode: 'TR-FLEET-ACCIDENTS', name: 'Fleet Accident History', domain: 'Business', category: 'Fleet Management', subcategory: 'Fleet Safety', family: 'Operational Risk', severity: 'Critical', definition: { official: 'Fleet Accident History identified in transport operations.', customer: 'Fleet accidents have occurred in the past 3 years.', technical: 'Customer reports fleet accidents in the past 3 years.' }, businessContext: ["Transport"], question: 'TRN_012', triggerAnswers: ["Yes"], penaltyScore: 20, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-TR-006', riskCode: 'TR-NO-EMERGENCY-PROCEDURES', name: 'No Emergency Procedures', domain: 'Business', category: 'Fleet Management', subcategory: 'Emergency Preparedness', family: 'Operational Risk', severity: 'Critical', definition: { official: 'No Emergency Procedures identified in transport operations.', customer: 'You have no written emergency procedures for accidents or incidents.', technical: 'Customer reports no written emergency procedures for accidents or incidents.' }, businessContext: ["Transport"], question: 'TRN_020', triggerAnswers: ["No"], penaltyScore: 20, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-TR-007', riskCode: 'TR-NO-FIRE-EXTINGUISHERS', name: 'No Fire Extinguisher Coverage', domain: 'Legal', category: 'Compliance', subcategory: 'Fire Safety', family: 'Property Risk', severity: 'High', definition: { official: 'No Fire Extinguisher Coverage identified in transport operations.', customer: 'Fire extinguishers are not regularly inspected or available across your facility.', technical: 'Customer reports fire extinguishers not regularly inspected or available across the facility.' }, businessContext: ["Transport"], question: 'TRN_021', triggerAnswers: ["No"], penaltyScore: 15, impacts: ["Legal","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-TR-008', riskCode: 'TR-NO-CLOSURE-RESILIENCE', name: 'No Financial Resilience to Closure', domain: 'Property', category: 'Insurance', subcategory: 'Financial Resilience', family: 'Financial Vulnerability', severity: 'Critical', definition: { official: 'No Financial Resilience to Closure identified in transport operations.', customer: 'Your operation could not sustain expenses during a one-month unexpected closure.', technical: 'Customer reports insufficient financial reserves to cover operating expenses during a one-month closure.' }, businessContext: ["Transport"], question: 'TRN_022', triggerAnswers: ["No","Not sure"], penaltyScore: 25, impacts: ["Financial","Legal"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-TR-009', riskCode: 'TR-NO-COMPLIANCE-OWNER', name: 'No Designated Compliance Responsibility', domain: 'Legal', category: 'Compliance', subcategory: 'Safety Governance', family: 'Compliance Risk', severity: 'Critical', definition: { official: 'No Designated Compliance Responsibility identified in transport operations.', customer: 'No one is specifically responsible for safety and compliance.', technical: 'Customer reports no designated person responsible for safety and compliance.' }, businessContext: ["Transport"], question: 'TRN_023', triggerAnswers: ["No one specifically assigned"], penaltyScore: 20, impacts: ["Legal","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' },
    { riskId: 'RISK-TR-010', riskCode: 'TR-UNTRAINED-DRIVERS', name: 'Untrained Drivers', domain: 'Legal', category: 'Worker Protection', subcategory: 'Driver Training', family: 'Operational Risk', severity: 'High', definition: { official: 'Untrained Drivers identified in transport operations.', customer: 'Your drivers lack defensive driving and first aid training.', technical: 'Customer reports identified transport operation risks.' }, businessContext: ["Transport"], question: 'TRN_024', triggerAnswers: ["No","Not sure"], penaltyScore: 15, impacts: ["Legal","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-TR-011', riskCode: 'TR-NO-VEHICLE-INSPECTIONS', name: 'No Vehicle Safety Inspections', domain: 'Business', category: 'Fleet Management', subcategory: 'Vehicle Inspections', family: 'Operational Risk', severity: 'High', definition: { official: 'No Vehicle Safety Inspections identified in transport operations.', customer: 'Your drivers lack defensive driving and first aid training.', technical: 'Customer reports drivers not trained in defensive driving and first aid.' }, businessContext: ["Transport"], question: 'TRN_025', triggerAnswers: ["No","Not sure"], penaltyScore: 15, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-TR-012', riskCode: 'TR-NO-FIRE-ALARM', name: 'No Fire Alarm System', domain: 'Legal', category: 'Compliance', subcategory: 'Fire Safety', family: 'Property Risk', severity: 'High', definition: { official: 'No Fire Alarm System identified in transport operations.', customer: 'Your depot or yard lacks a working fire alarm system.', technical: 'Customer reports no working fire alarm system at depot or yard.' }, businessContext: ["Transport"], question: 'TRN_026', triggerAnswers: ["No","Not sure"], penaltyScore: 15, impacts: ["Legal","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Medium' },
    { riskId: 'RISK-TR-013', riskCode: 'TR-POOR-DEPOT-MAINTENANCE', name: 'Infrequent Depot Maintenance', domain: 'Business', category: 'Fleet Management', subcategory: 'Depot Maintenance', family: 'Property Risk', severity: 'Critical', definition: { official: 'Infrequent Depot Maintenance identified in transport operations.', customer: 'Building or facility maintenance inspections are infrequent or non-existent.', technical: 'Customer reports building maintenance inspections conducted rarely or never.' }, businessContext: ["Transport"], question: 'TRN_027', triggerAnswers: ["Rarely","Never"], penaltyScore: 20, impacts: ["Operational","Financial"], detectability: 'High', preventability: 'High', recoverability: 'Low' }
  ],
  SME: [
