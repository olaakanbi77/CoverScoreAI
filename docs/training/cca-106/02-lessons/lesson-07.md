# CCA 106 — Lesson 7: Client Retention, Referrals & Lifetime Advisory Relationships
...
> **Placeholder:** Lesson 7 overview — complete from the module blueprint when supplied.
...
|-------|-------|------------------|
| 1 | Client Retention, Referrals & Lifetime Advisory Relationships | Lesson title + objectives |
...
**Exercise 7.1 — [Title]** — [Duration + instruction]
**Exercise 7.2 — [Title]** — [Duration + instruction]
**Exercise 7.3 — [Title]** — [Duration + instruction]

## 7. Case Study

> **Placeholder:** Lesson 7 case study — scenario + tasks — complete from the module blueprint when supplied.
...
- **KB-7.1 [Topic]:** [Knowledge entry]
- **KB-7.2 [Topic]:** [Knowledge entry]
- **KB-7.3 [Topic]:** [Knowledge entry]
- **KB-7.4 [Topic]:** [Knowledge entry]
- **KB-7.5 [Topic]:** [Knowledge entry]

## 10. AI Coaching Prompts

- **Prompt 7.1 ([Drill type]):** [Prompt]
- **Prompt 7.2 ([Drill type]):** [Prompt]
- **Prompt 7.3 ([Drill type]):** [Prompt]
