# CCA 108 — Lesson 2: Integrated Client Engagement Simulation
...
> **Placeholder:** Lesson 2 overview — complete from the module blueprint when supplied.
...
|-------|-------|------------------|
| 1 | Integrated Client Engagement Simulation | Lesson title + objectives |
...
**Exercise 2.1 — [Title]** — [Duration + instruction]
**Exercise 2.2 — [Title]** — [Duration + instruction]
**Exercise 2.3 — [Title]** — [Duration + instruction]

## 7. Case Study

> **Placeholder:** Lesson 2 case study — scenario + tasks — complete from the module blueprint when supplied.
...
- **KB-2.1 [Topic]:** [Knowledge entry]
- **KB-2.2 [Topic]:** [Knowledge entry]
- **KB-2.3 [Topic]:** [Knowledge entry]
- **KB-2.4 [Topic]:** [Knowledge entry]
- **KB-2.5 [Topic]:** [Knowledge entry]

## 10. AI Coaching Prompts

- **Prompt 2.1 ([Drill type]):** [Prompt]
- **Prompt 2.2 ([Drill type]):** [Prompt]
- **Prompt 2.3 ([Drill type]):** [Prompt]
