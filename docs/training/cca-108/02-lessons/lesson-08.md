# CCA 108 — Lesson 8: Final Integrated Advisory Simulation & Professional Assessment
...
> **Placeholder:** Lesson 8 overview — complete from the module blueprint when supplied.
...
|-------|-------|------------------|
| 1 | Final Integrated Advisory Simulation & Professional Assessment | Lesson title + objectives |
...
**Exercise 8.1 — [Title]** — [Duration + instruction]
**Exercise 8.2 — [Title]** — [Duration + instruction]
**Exercise 8.3 — [Title]** — [Duration + instruction]

## 7. Case Study

> **Placeholder:** Lesson 8 case study — scenario + tasks — complete from the module blueprint when supplied.
...
- **KB-8.1 [Topic]:** [Knowledge entry]
- **KB-8.2 [Topic]:** [Knowledge entry]
- **KB-8.3 [Topic]:** [Knowledge entry]
- **KB-8.4 [Topic]:** [Knowledge entry]
- **KB-8.5 [Topic]:** [Knowledge entry]

## 10. AI Coaching Prompts

- **Prompt 8.1 ([Drill type]):** [Prompt]
- **Prompt 8.2 ([Drill type]):** [Prompt]
- **Prompt 8.3 ([Drill type]):** [Prompt]
