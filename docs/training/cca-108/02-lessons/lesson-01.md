# CCA 108 — Lesson 1: Capstone Orientation & the Complete CoverScore Advisory Cycle
...
> **Placeholder:** Lesson 1 overview — complete from the module blueprint when supplied.
> Place in the module: opening lesson establishing the module's mindset and roadmap.
...
|-------|-------|------------------|
| 1 | Capstone Orientation & the Complete CoverScore Advisory Cycle | Lesson title + objectives |
| [n] | [Slide title] | [Content / visual] |
| [n] | [Slide title] | [Content / visual] |
| [n] | [Slide title] | [Content / visual] |
| [n] | [Slide title] | [Content / visual] |
| [n] | [Slide title] | [Content / visual] |
...
**Exercise 1.1 — [Title]** — [Duration + instruction]
**Exercise 1.2 — [Title]** — [Duration + instruction]
**Exercise 1.3 — [Title]** — [Duration + instruction]

## 7. Case Study

> **Placeholder:** Lesson 1 case study — scenario + tasks — complete from the module blueprint when supplied.
...
- **KB-1.1 [Topic]:** [Knowledge entry]
- **KB-1.2 [Topic]:** [Knowledge entry]
- **KB-1.3 [Topic]:** [Knowledge entry]
- **KB-1.4 [Topic]:** [Knowledge entry]
- **KB-1.5 [Topic]:** [Knowledge entry]

## 10. AI Coaching Prompts

- **Prompt 1.1 ([Drill type]):** [Prompt]
- **Prompt 1.2 ([Drill type]):** [Prompt]
- **Prompt 1.3 ([Drill type]):** [Prompt]
