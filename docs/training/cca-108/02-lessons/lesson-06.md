# CCA 108 — Lesson 6: Professional Practice, Portfolio Management & Risk Review Simulation
...
> **Placeholder:** Lesson 6 overview — complete from the module blueprint when supplied.
...
|-------|-------|------------------|
| 1 | Professional Practice, Portfolio Management & Risk Review Simulation | Lesson title + objectives |
...
**Exercise 6.1 — [Title]** — [Duration + instruction]
**Exercise 6.2 — [Title]** — [Duration + instruction]
**Exercise 6.3 — [Title]** — [Duration + instruction]

## 7. Case Study

> **Placeholder:** Lesson 6 case study — scenario + tasks — complete from the module blueprint when supplied.
...
- **KB-6.1 [Topic]:** [Knowledge entry]
- **KB-6.2 [Topic]:** [Knowledge entry]
- **KB-6.3 [Topic]:** [Knowledge entry]
- **KB-6.4 [Topic]:** [Knowledge entry]
- **KB-6.5 [Topic]:** [Knowledge entry]

## 10. AI Coaching Prompts

- **Prompt 6.1 ([Drill type]):** [Prompt]
- **Prompt 6.2 ([Drill type]):** [Prompt]
- **Prompt 6.3 ([Drill type]):** [Prompt]
