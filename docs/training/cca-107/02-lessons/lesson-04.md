# CCA 107 — Lesson 4: Risk Reviews, Reassessments and Portfolio Monitoring
...
> **Placeholder:** Lesson 4 overview — complete from the module blueprint when supplied.
...
|-------|-------|------------------|
| 1 | Risk Reviews, Reassessments and Portfolio Monitoring | Lesson title + objectives |
...
**Exercise 4.1 — [Title]** — [Duration + instruction]
**Exercise 4.2 — [Title]** — [Duration + instruction]
**Exercise 4.3 — [Title]** — [Duration + instruction]

## 7. Case Study

> **Placeholder:** Lesson 4 case study — scenario + tasks — complete from the module blueprint when supplied.
...
- **KB-4.1 [Topic]:** [Knowledge entry]
- **KB-4.2 [Topic]:** [Knowledge entry]
- **KB-4.3 [Topic]:** [Knowledge entry]
- **KB-4.4 [Topic]:** [Knowledge entry]
- **KB-4.5 [Topic]:** [Knowledge entry]

## 10. AI Coaching Prompts

- **Prompt 4.1 ([Drill type]):** [Prompt]
- **Prompt 4.2 ([Drill type]):** [Prompt]
- **Prompt 4.3 ([Drill type]):** [Prompt]
